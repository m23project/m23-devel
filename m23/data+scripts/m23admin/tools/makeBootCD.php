...
<?php
	...
	<tr>
		<td>
			<span class=\"title\">$I18N_used_burner</span><br><br>".BURN_listBurners(&$burner)."<input type=\"submit\" name=\"BUT_select\" value=\"$I18N_select\"><br>
		</td>
	</tr>");
	HTML_showTableEnd();
	...
	<tr>
		<td>
			<span class=\"title\">$I18N_blank_cdrw</span><br><br>
	...
	echo("
		<tr>
			<td><span class=\"title\">$I18N_make_bootcd</span><br><br></td>
		</tr>
		<tr>
			<td align=\"center\">
