...
//generates /etc/apt/sources.list
	...
	CLCFG_installBasePackages("powermgmt-base console-common console-data console-tools less screen sed ssh netkit-ping net-tools $ntpPackage parted hotplug gawk hdparm dialog locales $clientOptions[bootloader] hwsetup hwdata-knoppix m23-initscripts m23hwscanner m23-skel ". $clientOptions['kernel']);
